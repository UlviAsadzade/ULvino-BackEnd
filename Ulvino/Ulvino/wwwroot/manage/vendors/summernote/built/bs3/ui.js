...
var toolbar = renderer_1["default"].create('<div class="note-toolbar-wrapper panel-default"><div class="note-toolbar panel-heading"></div></div>');
...
var ui = {
    ...
    button: function ($node, options) {
        return renderer_1["default"].create('<button type="button" class="note-btn btn btn-default btn-sm" tabindex="-1">', function ($node, options) {
